...
int main(){
    ...
    person1.setPersonAge(10); person2.setPersonContactInfo(9079059041);
    ...
    c1.setCourseCode("MAL151"); c2.setCourseTitle("good course T_T");
    ...
    s1->setPersonName("Nitesh");

    s1->setPersonID(10120);

    s1->setPersonAge(18);

    s1->setPersonContactInfo(9079059041);
...
void testAssistantFunctionality(){
    ...
    gradStudent->setPersonName("Nitesh");

    gradStudent->setPersonID(10120);

    gradStudent->setPersonAge(18);

    gradStudent->setPersonContactInfo(9079059041);
